    ...
    <ResultsOuter>
      ...
      {!loading && fixResult && (
        <>
          ...
          {(fixResult.memoryLeakFixResults?.countOfleaks?.totalCountOfPotentialLeaks != 0) && <PatchTableCard title={'Detailed Patch Breakdown'} fixResult={fixResult} diffData={diffData}/>}
        </>
      )}
